...
/**
 * Initial state test of parentEnterprise
 *
...
/**
 * Allows to test the initial state of parentEnterprise
 */
describe('enterprise', () => {
	test('enterprise test initialState', () => {
		initialState.enterprise === null;
		initialState.enterpriseError === null;
	});
});
