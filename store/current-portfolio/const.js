 ...
 *
 */
const RESOURCE = transactions.currentPortfolio;
const BASE = mergeWithAppName(RESOURCE);
const PORTFOLIO_XLS_RESOURCE = transactions.portfolioXLS;
const PORTFOLIO_XLS_BASE = mergeWithAppName(PORTFOLIO_XLS_RESOURCE);
...
export const PORTFOLIO_XLS_START = `${PORTFOLIO_XLS_BASE}/START`;
export const PORTFOLIO_XLS_SUCCESS = `${PORTFOLIO_XLS_BASE}/SUCCESS`;
export const PORTFOLIO_XLS_ERROR = `${PORTFOLIO_XLS_BASE}/ERROR`;
